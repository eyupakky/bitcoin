...
class CoinModel {
  ...
  late String name;
  late String image;
  late var currentPrice;
  late var marketCap;
  late var marketCapRank;
  late var fullyDilutedValuation;
  late var totalVolume;
  late var high24h;
  late var low24h;
  late var priceChange24h;
  late var priceChangePercentage24h;
  late var marketCapChange24h;
  late var marketCapChangePercentage24h;
  late var circulatingSupply;
  late var totalSupply;
  late var maxSupply;
  late var ath;
  late var athChangePercentage;
  late String athDate;
  late var atl;
  late var atlChangePercentage;
  late String atlDate;
  late var roi;
  late String lastUpdated;
  late var priceChangePercentage1hInCurrency;
  late var priceChangePercentage7dInCurrency;
  CoinModel(
      this.id,
      this.symbol,
      this.name,
  ...
  CoinModel.fromJson(Map json){
    ...
    totalSupply = json['circulating_supply']!=null?json['circulating_supply']:"0";
